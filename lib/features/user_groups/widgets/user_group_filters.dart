...
class UserGroupFilters extends StatelessWidget {
  const UserGroupFilters({
    super.key,
    required this.searchController,
    required this.selectedIsActive,
    required this.selectedIsApproved,
    ...
    return Wrap(
      ...
      children: [
        SizedBox(
          ...
          child: TextField(
            ...
            decoration: const InputDecoration(
              labelText: 'Search user groups',
              hintText: 'Group name or description',
        ...
        SizedBox(
          width: 200,
          child: DropdownButtonFormField<bool?>(
            initialValue: selectedIsApproved,
            decoration: const InputDecoration(
              labelText: 'Approval',
              border: OutlineInputBorder(),
            ),
            ...
            onChanged: isLoading ? null : onApprovalChanged,
          ),
        ),
